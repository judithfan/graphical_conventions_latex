...
Recent computational models of visual communication have found that both how costly a drawing is produce and how informative a drawing is in context are critical for explaining the way people spontaneously adjust the level of detail to include in their drawings in one-shot visual communication tasks \cite{fan2019pragmatic}. 
The consequences of this intrinsic preference for less costly drawings (i.e., less time, fewer strokes) may be compounded across repetitions, as the accumulation of shared experience allows people to be equally informative with fewer strokes \cite<see>[for a formal model]{HawkinsFrankGoodman17_ConventionFormation}.
