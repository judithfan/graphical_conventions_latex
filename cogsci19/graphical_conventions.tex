...
A mixed-effects regression model with random intercepts for both sketcher and object revealed that similarity between successive drawings increased substantially throughout an interaction ($b = 0.53,~t = 5.03$; Fig.~\ref{within-across}D). 
