...
On each trial, both players were shown an array of four objects, one of which was privately designated as the `target' to the sketcher.
...
The interaction was instead driven by differential improvements in reaction time (original: 11s to 6s, yoked:  in the original experiment and only from 4.6s to 3.3s in the yoked condition.
These differences reflect the contribution of additional sketch production time in the original experiment.
