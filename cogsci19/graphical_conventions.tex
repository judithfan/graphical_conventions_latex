...
245 participants recruited via AMT completed the experiment. Data from 22 participants were excluded due to low accuracy on attention-check trials (3 or fewer correct out of 5).  
...
\subsubsection{Third-party observers able to accumulate interaction-specific knowledge show comparable gains in recognition performance}

We predicted that participants in the yoked group would e
...
\subsubsection{Third-party observers viewing sketches from different interactions }
