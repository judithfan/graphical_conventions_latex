...
We again used VGG-19 to encode 

To encode the high-level visual features of each drawing, we again used the VGG-19 architecture We used model activations in the second-to-last layer of this network
