...
\meg{I tried to rewrite this part as clearly as possible, but it's hard without sounding super systematic. Could we insert an equation here to explain how we computed ``mean pairwise similarity''? It could look something like this: for a given object $o$ and repetition $r$, we compute: $\frac{1}{\binom{N}{2}} \sum_{i = 1}^N \sum_{j = i+1}^N sim(S_{i, o, r}, S_{j, o, r})$. It just seems like a more compact way of effectively communicating the computation.}
