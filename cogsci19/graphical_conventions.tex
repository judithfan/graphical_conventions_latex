...
Unlike viewers in the interactive visual communication experiment, participants in the yoked condition made their decision based only on the final drawing and were unable to interrupt or await additional information if they were still uncertain.
...
The more dissimilar the lesioned drawing without a particular stroke is to the next repetition's drawing, the more ``important'' we considered that stroke to be.
...
A mixed-effects model with random intercepts for both object and sketcher showed that similarity between successive drawings increased substantially throughout an interaction ($b = 0.53,~t = 5.03$; Fig.~\ref{within-across}).
