...
\subsection{Results: Repeated reference leads to more efficient communication}
...
\red{btw, what was game inclusion criteria -- definition of crazy in df generation helpers?}
...
To evaluate this prediction, we employed a measure of communication efficiency that combines both accuracy and speed (i.e., Balanced Integration Score; \citeNP{Liesefeld2018}). 
Accuracy was quantified as the proportion 
...
We found a significant interaction: sketches of repeated targets showed a greater increase in efficiency than control targets shown only at the beginning and end ($b = X.XX. t = X.XX, p = X.XX$; see Figure ). 
