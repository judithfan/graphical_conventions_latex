...
Our paper reconciles these two perspectives by proposing that both visual information and social context may jointly explain how drawings derive meaning \cite{fan2018modeling}, and that a critical factor affecting the balance between the two may be the degree of shared knowledge between communicators. 
Here we explore the specific hypothesis that the accumulation of shared knowledge via  may promote the development of simple, consistent, and effective ways to depict something, even if these \textit{ad hoc} graphical conventions are not immediately interpretable to others. 
