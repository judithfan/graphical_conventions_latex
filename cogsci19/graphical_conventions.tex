...
% and earned up to \$0.04 bonus for each correct trial, inversely proportional to the amount of time taken. 
...
Our approach was to define sets of perceptually similar real-world objects belonging to the same basic-level category.
To accomplish this, we selected objects from the ShapeNet database \cite{chang2015shapenet}.
