...
%I think this is same repetition number but not same trial number
...
As such, this control experiment provided an estimate of how much of the performance gains observed in the communication experiment could be attributable to the availability of these channels for social interaction. 
...
\subsubsection{Sketches drift away from the initial round}
...
The increasing similarity of successive sketches over time motivates an investigation into which part of a sketch stays consistent across successive repetitions. 
Here, we use stroke lesions to provide a visualization of stroke importance of a sketch with respect to its successive sketch. 
