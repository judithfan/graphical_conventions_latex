...
On the other hand, other work has emphasized the role of socially-mediated information and context for make appropriate inferences about even what a figurative drawing means \cite{goodman1976languages,gombrich1969art,garrod_foundations_2007}.
...
Furthermore, we found that drawings became increasingly consistent within an interaction, but that different pairs discovered different solutions for efficient communication, revealing the existence of multiple equilibria in the space of graphical conventions. 
...
Our work was inspired by a large literature that has investigated the emergence of communicative conventions in the linguistic \cite{ClarkWilkesGibbs86_ReferringCollaborative,HawkinsFrankGoodman17_ConventionFormation}, gesture (cite), and graphical modalities \cite{garrod_foundations_2007,fay2010interactive,Galantucci:2005uh,healey2007graphical,theisen2010systematicity}. 
The current paper makes the following contributions that advance this prior work:
