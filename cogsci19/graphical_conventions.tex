...
A linear mixed-effects model with random intercepts for both sketcher and object revealed that similarity between successive drawings increased substantially over time ($b = 0.53,~t = 5.03$;  Fig.~\ref{within-across}). 
