...
On each trial, recognition participants were presented with the same set of four objects and drawing that viewers had in the communication game. 
...
Thus any differences between the yoked and shuffled groups are attributable to whether drawings came from the same communicative interaction --- supporting the accumulation of interaction-specific shared knowledge --- or several different interactions --- where such accumulation would be minimal.

\subsection{Results}

\subsubsection{Yoked similar to reference game}
...
\subsubsection{Viewers improve to greater degree when drawings }
