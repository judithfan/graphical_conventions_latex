...
Viewers in the original experiment identified 88\% of drawings correctly, compared to 75\% by participants in the yoked condition, $t = 6.2, ~p < 0.001$.\footnote{Note that response times in the yoked condition were a function of viewer performance, whereas in the communication experiment they were a function of both sketcher \emph{and} viewer performance.}
