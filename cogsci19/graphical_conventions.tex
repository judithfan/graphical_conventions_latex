...
245 participants recruited via AMT completed the experiment. Data from 22 participants were excluded who did not meet our criterion for accurate and consistent responding on attention-check trials.
...
Each attention-check trial presented the same sketch and objects, which was produced in the highest-performing communication experiment and was identified based on initial piloting to be the most consistently and accurately recognized by naive participants. 
Participants who did not respond correctly on at least 4 out of 5 of attention-check were excluded from subsequent analyses (N=22).
...
This analysis revealed that recognition performance increased overall as a function of repetition number ($b = 0.184, ~t = 12.8, ~p < 1x10^{-15}$)
