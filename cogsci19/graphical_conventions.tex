...
Computational models, or lesion analyses like those preliminarily reported above, are promising approaches toward distinguishing among these possibilities in future work.%, in combination with the development of computational models of drawing production that account for part-level semantic structure.
