...
In these experiments, naive participants performed a drawing recognition task in which they were presented with the final drawings from the communication experiment and guessed which of four objects it referenced. 
...
How do the sketches themselves change? First, we observed that the number of strokes constituting sketches decreased by repetition. 
