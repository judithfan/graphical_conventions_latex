...
This work was inspired by a classic literature that has investigated how extended interaction promotes the formation of communicative conventions in the linguistic \cite{ClarkWilkesGibbs86_ReferringCollaborative,HawkinsFrankGoodman17_ConventionFormation}, gesture (cite), and graphical modalities \cite{garrod_foundations_2007,fay2010interactive,Galantucci:2005uh,healey2007graphical,theisen2010systematicity}. 
...
second, our control experiments measuring the recognizability of drawings by naive viewers carefully control for task practice, providing clearer evidence for the importance of continuity...
