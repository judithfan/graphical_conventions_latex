...
Specifically, we measured the importance of each stroke by re-rendering the sketch without that stroke and computing the CNN-based similarity (see Fig. \ref{within-across}).
We observed that %The color of a stroke in a sketch corresponds to the similarity of the sketch to its successor when removing that stroke from the sketch. 
