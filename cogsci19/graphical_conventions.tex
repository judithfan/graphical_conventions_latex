...
Participants who responded incorrectly on at least 4 out of 5 of these trials were excluded from subsequent analyses.
...
As such, comparing the yoked and original communication groups provides an estimate of the contribution of these viewer feedback channels to gains in performance\footnote{Note that response times in the yoked condition were purely a function of viewer performance whereas in the original experiment they were a joint function of sketcher \emph{and} listener behavior.} \cite{schober_understanding_1989}.
...
\begin{figure}
\begin{center}
\includegraphics[width=0.95 \linewidth]{figures/recog_BIS_timeseries.pdf}
...
Lesion analyses like those preliminarily reported above are a promising approach toward distinguishing among these possibilities in future work.%, in combination with the development of computational models of drawing production that account for part-level semantic structure.
