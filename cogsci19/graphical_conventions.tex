...
A straightforward explanation for the gains in communication efficiency we observed in Part I is that sketchers were able to use fewer strokes per drawing to achieve the same level of communicative efficacy.
In 
