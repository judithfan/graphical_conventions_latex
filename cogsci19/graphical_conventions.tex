...
\begin{figure*}
\includegraphics[width=0.2\linewidth]{figures/drift.pdf}
\includegraphics[width=0.2\linewidth]{figures/within.pdf}
\includegraphics[width=0.2\linewidth]{figures/across.pdf}
\includegraphics[scale = .5]{figures/fig_a.png}
...
\subsubsection{Sketches become more dissimilar from initial round}

$b = -0.62, t = -5.59$

\subsubsection{Sketchers draw the same object increasingly consistently}

While we noticed that sketches grew steadily different from the initial sketch, we noticed that this displacement \emph{slowed down} considerably.
