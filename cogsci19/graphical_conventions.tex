...
To do this, for each object, we consider the set of all interactions in which the object appeared as a repeated object. Now, for a pair of interactions in this set, we compute the similarity between the drawings from these interactions such that they refer to the same given object and are drawn in the same repetition. Averaging this similarity value over all possible pairs of interactions gives us the mean between-interaction similarity for a given object and a given repetition.
