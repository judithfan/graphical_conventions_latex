...
These findings show that the benefits of repeatedly communicating about an object are to some extent specific to that object, exceeding the generic benefits of extended interaction. 
