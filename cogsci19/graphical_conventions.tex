...
\caption{Examples of conventions that formed for different objects \rdh{should put target image at left with `target' label; add more rows}} 
\label{task_stimuli}
\end{figure}
...
\includegraphics[scale = .3]{figures/stroke_importance.pdf}
