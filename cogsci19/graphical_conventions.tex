...
A linear mixed-effects model with random intercepts for both sketcher and object revealed that similarity between successive drawings increased substantially throughout an interaction ($b = 0.53,~t = 5.03,~p<0.001$; Fig.~\ref{within-across}). 
...
The empirical effect fell far outside than this null distribution, $p < .001, CI = [-3.21, -0.60]$, providing strong evidence that increasingly consistent ways of drawing each object emerged only for series of drawings produced within the same interaction. 
