...
For each game, we randomly sampled two sets of four objects: one was the \emph{repeated} set and the other was the \emph{control} set (see Fig. \ref{task_stimuli}B).
In half of the pairs (N= pairs), the repeated set contained four randomly sampled objects from one category and the control set contained the remaining four objects from the same category. 
...
The communication task consisted of three phases (Fig. \ref{task_stimuli}C). 
