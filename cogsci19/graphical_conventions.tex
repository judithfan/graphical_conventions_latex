...
For each pair and target object, we scrambled sketches across repetitions and re-ran our mixed-effects model to generate a null distribution of $t$ values $(CI = [-0.57, 0.60])$.
The observed effect was highly unlikely under this distribution,~$p~<~0.001$.
