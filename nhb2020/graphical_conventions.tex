...
\subsection{Measuring improvement in task performance}
...
We found that pairs identified the target at rates well above chance in this phase (76\%, chance = 25\%), suggesting that they were engaged with the task but not at ceiling performance.
...
\subsection{Measuring object-specificity}
...
We tested this hypothesis by comparing performance between the repeated and control conditions.
On the pre-test, there was no difference between conditions (75.7\% repeated, 76.1\% control).
