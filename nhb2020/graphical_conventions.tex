...
To test this hypothesis, we ran several additional studies.
First, to obtain reliable estimates of diagnosticity in context, we required a variant of our task using stable contexts instead of randomly sampling different contexts for each pair of participants.
...
Second, we recruited independent judges to provide annotations of these drawings. 
...
These ratings can be combined to measure changes in diagnosticity as conventions are formed.
...
\todo[inline]{TODO: fill in more details}
