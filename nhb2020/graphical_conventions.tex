...
This yielded at least 30 ratings for each pair of chairs, and we aggregated diagnosticity ratings across pairs in post-processing by taking the mean pixel intensity for each pixel.
