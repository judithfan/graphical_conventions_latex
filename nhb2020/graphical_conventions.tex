...
\subsection{Conventions are driven by diagnosticity}
...
Instead of randomly sampling different contexts for each pair of participants, as before, we designed a new reference games using only two pre-generated contexts for every pair, which were counter-balanced across the \emph{repeated} and \emph{control} conditions. 
