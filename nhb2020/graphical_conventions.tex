...
% A long-standing debate in theories of depiction concerns how drawings derive their meaning.
...
To test this hypothesis, and obtain reliable estimates of diagnosticity in context, we required more data for a particular set of contexts instead of randomly sampling different contexts for each pair of participants.
